...
let currentPerson;
//localStorage.removeItem("giftr-maci0182");
...
function saveToLocalStorage(){
    localStorage.setItem("giftr-maci0182", JSON.stringify(people));
}

function getFromLocalStorage(){
    if(!localStorage.getItem("giftr-maci0182")){
        console.log("No data found");
    }
    else{
        people = JSON.parse(localStorage.getItem("giftr-maci0182"));
